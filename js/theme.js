...
form.on('submit', function (e) {
    ...
    $.ajax({
        url: 'https://formspree.io/f/xblrjjkl', // Formspree endpoint
        type: 'POST', // form submit method
        dataType: 'json', // request type
        ...
        success: function (data) {
            submit.before('<div class="alert alert-success alert-dismissible">Your message has been sent.</div>').fadeIn("slow"); // fade in response data 
        ...
        error: function (e) {
            ...
            submit.html(submit.data('original-text'));// reset submit button text
            submit.removeAttr("disabled", "disabled");
            submit.before('<div class="alert alert-danger alert-dismissible">There was an error sending your message. Please try again.</div>').fadeIn("slow");
            setTimeout(function () {
                $('.alert-dismissible').fadeOut('slow', function(){
                    $(this).remove();
                });
